...
- La detección se ejecuta sobre una copia reducida usando gradientes, candidatos geométricos y validación de cuadrilátero; el warp final se realiza sobre la foto de alta resolución disponible.
...
- OpenCV.js no se incluye en el primer bundle: la detección y la perspectiva tienen una implementación local en Canvas para evitar un coste inicial alto.
